...
sound1 = scene.get_sound('instrumental', 'buchla', 0, 60)
sound2 = scene.get_sound('instrumental', 'buchla', 1, 60)
sound3 = scene.get_sound('instrumental', 'buchla', 2, 60)
sound4 = scene.get_sound('instrumental', 'classical', 0, 60)
sound5 = scene.get_sound('instrumental', 'classical', 0, 60)
