...
def main():
    ...
    #reshape
    training_predictors = training_predictors.reshape(training_predictors.shape[0], 1, 1, training_predictors.shape[1])
    validation_predictors = validation_predictors.reshape(validation_predictors.shape[0], 1, 1, validation_predictors.shape[1])
    test_predictors = test_predictors.reshape(test_predictors.shape[0], 1, 1, test_predictors.shape[1])
