...
scene.get_scored_sound(sound1, 30, 0.7, 0.7, pan=[0,0.2], id=0, fade_in=4000, fade_out=5000)
scene.get_scored_sound(sound2, 30, .8, 0.6, pan=[-1,-1], id=1, fade_in=4000, fade_out=5000)
scene.get_scored_sound(sound3, 20, 0.8, 0.3, pan=[0.9,0.7], id=2, fade_in=4000, fade_out=5000)
scene.get_scored_sound(sound4, 10, 0.6, 0.23, pan=[-.2,-.2], id=3, rev=True, stretch=0.4, fade_in=4000, fade_out=5000)
scene.get_scored_sound(sound5, 40, 0.2, 0., pan=[-.7,-.2], id=4, rev=True, fade_in=4000, fade_out=5000, shift=-36)
